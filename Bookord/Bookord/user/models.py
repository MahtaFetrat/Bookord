...
class Book(models.Model):
    ...
    additional_image_1 = models.ImageField(upload_to=book_additional_path, null=True, blank=True)
    additional_image_2 = models.ImageField(upload_to=book_additional_path, null=True, blank=True)
    additional_image_3 = models.ImageField(upload_to=book_additional_path, null=True, blank=True)
